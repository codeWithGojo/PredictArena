...
export async function GET() {
  ...
  return Response.json({
    ...
    provider: `${[...new Set(football.leagueCatalog.map((league) => league.provider))].join(" + ")} + TheSportsDB`,
    footballProvider: [...new Set(football.leagueCatalog.map((league) => league.provider))].join(" / "),
